    ...
    animations: [
        ...
        trigger('wildState', [
            ...
            transition('shrunken <=> *', [
                ...
                animate(200, style({ transform: 'rotate(900deg)' })),
        ...
        trigger('list1', [
            ...
            // :enter can also be used here to add a new element to the DOM
            transition('void => *', [
                style({ opacity: 0, transform: 'translateX(-100px)' }),
                animate(300)
            ]),
            // :leave can also be used here to remove an element from the DOM
            transition(
                '* => void',
